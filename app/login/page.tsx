              ...
              <form onSubmit={handleResetPassword} className="space-y-4">
                ...
                <div>
                  ...
                  <input type="password" value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} placeholder="••••••••" required
                    style={{ ...inputStyle, borderColor: confirmNewPassword && confirmNewPassword !== newPassword ? "#ef4444" : "rgba(255,255,255,0.15)" }}
                    onFocus={(e) => (e.target.style.borderColor = "#6d28d9")} onBlur={(e) => (e.target.style.borderColor = confirmNewPassword !== newPassword ? "#ef4444" : "rgba(255,255,255,0.15)")} />
                ...
                {!isLogin && (
                  <div>
                    ...
                    <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="••••••••" required={!isLogin}
                      style={{ ...inputStyle, borderColor: confirmPassword && confirmPassword !== password ? "#ef4444" : "rgba(255,255,255,0.15)" }}
                      onFocus={(e) => (e.target.style.borderColor = "#6d28d9")}
                      onBlur={(e) => (e.target.style.borderColor = confirmPassword !== password ? "#ef4444" : "rgba(255,255,255,0.15)")} />
